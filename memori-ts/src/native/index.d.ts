...
export declare class MemoriEngine {
  constructor(modelName: string | undefined | null, fetchEmbeddingsCb: ((err: Error | null, arg0: number, arg1: string) => any), fetchFactsByIdsCb: ((err: Error | null, arg0: number, arg1: string) => any), writeBatchCb: ((err: Error | null, arg0: number, arg1: string) => any))

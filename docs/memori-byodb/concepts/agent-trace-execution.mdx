...
Memori doesn't just extract memory from conversations, it can learn from agent execution itself. 
By capturing tool calls, decisions, workflow steps, outcomes, and other trace events, Memori turns raw execution history into structured memory primitives that agents can recall and reuse across sessions.
